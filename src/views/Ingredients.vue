...
<template>
  <div class="p-8 pb-0 text-orange-500">
    <h1 class="text-4xp font-bold mb-4">Search Meals By Ingredients</h1>
  </div>

  <!-- {{ ingredients }} -->

    <div class="p-10">
      <input type="text" v-model="keyword" class="rounded border-2 border-gray-200 w-full bf-white mb-5" 
      ...
      <div class="grid grid-cols-4 gap-5">
        ...
        class="bg-white rounded [-3 mb-3 shadow block">
