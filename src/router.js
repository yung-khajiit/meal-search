...
import MealsByIngerdients from './views/MealsByIngerdients.vue'
...
const routes = [
  ...
  { path: '/meal-search/by-ingredient/:ingredient?', name: 'MealsByIngredients', component: MealsByIngerdients },
